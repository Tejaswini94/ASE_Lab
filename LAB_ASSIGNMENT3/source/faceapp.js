...
function parseResponse(resp) {
    ...
    document.getElementById('data_bef_img').innerHTML='Image';
    document.getElementById('check').innerHTML = "<img src='"+val+"' height='300' width='400'/>";
    ...
    var msg = new SpeechSynthesisUtterance('Tags for given image are'+tags);
